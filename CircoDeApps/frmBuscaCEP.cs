...
namespace CICLOAPPS
{
    public partial class frmBuscaCEP : Form
    {
                        ...
                        foreach (var substring in substrings)
                        {
                            if (cont == 1)
                            {
                                if (substring.Contains(":"))
                                {
                                    ...
                                    {
                                        MessageBox.Show("CEP não encontrado!", "Erro de CEP", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                        txtCEP.Text = string.Empty;
                                        txtCEP.Focus();
                                        return;
                                    }
        ...
        private void txtCEP_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                MessageBox.Show("Esse campo aceita apenas números!", "LetraDigitada", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
    }
}
